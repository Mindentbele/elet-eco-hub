  ...
  return (
    <section className="py-16 bg-gradient-to-br from-tomato-500 to-tomato-600">
      <div className="max-w-3xl mx-auto px-5 text-center text-white">
        ...
        <h2 className="display text-3xl md:text-4xl font-extrabold">Iratkozz fel a hírlevelünkre</h2>
        <p className="mt-3 text-white/90">Heti kosártartalom, új termelők, akciók — egy emailben, hetente egyszer.</p>
        <form onSubmit={submit} className="mt-8 max-w-md mx-auto">
          ...
          <p className="mt-3 text-xs text-white/70">Bármikor leiratkozhatsz. Adataidat biztonságban kezeljük.</p>
        </form>
      </div>
    </section>
  );
